...
%Choices for simulations and how files are groupde
...
if all_files_present==1
    ...
    for fileNo=first_file:length(handles.FileName_pre_per)
        ...
        handles_choices.do_dPCA=do_cPCA; %dPCA is not performed, all the function does is to process the pre_per data to use in the dPCA code below
