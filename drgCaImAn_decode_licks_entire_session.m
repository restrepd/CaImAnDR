...
if exist('handles_choices')==0
    ...
    post_shift=7; %Set to 0 if you want to train with odor on points
...
dt_span=30; %Seconds for per trial traces centered on odor on, this used to be 40
...
for MLalgo=MLalgo_to_use
            ...
            if handles_not_out.MLalgo(MLalgo).processed_succesfully==1
                ...
                if MLalgo==6
                    ...
                    for ii=1:size(traces,2)
                        ...
                        % scores_sh(ii,:)=score;
                        %Note: I am getting this error for score. Since I
                        %do not use it I have decided to not save score
    ...
    if handles_not_out.MLalgo(MLalgo).processed_succesfully==1
        ...
        if show_figures==1
            ...
            ylim([-0.2 1.2])
            title(['Licks for entire session'])
