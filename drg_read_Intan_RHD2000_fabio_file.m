function [adc_in,digital_input,acq_rate,amplifier_data_out,adc_channel_names]=drg_read_Intan_RHD2000_fabio_file(filename)
...
for chno=1:length(board_adc_channels)
    adc_channel_names{chno}=board_adc_channels(chno).native_channel_name;
end
