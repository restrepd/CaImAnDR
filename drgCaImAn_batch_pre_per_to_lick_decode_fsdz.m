function drgCaImAn_batch_pre_per_to_lick_decode_fsdz(choiceBatchPathName,choiceFileName)
...
if all_files_present==1
    ...
    for fileNo=first_file:length(handles.FileName_pre_per)
        ...
        for ii_training=1:length(handles.training_time_from)
             
            handles_choices.p_threshold=1.1;
            handles_choices.post_time=handles.training_delta_time(ii_training);
            handles_choices.post_shift=handles.training_time_from(ii_training);
