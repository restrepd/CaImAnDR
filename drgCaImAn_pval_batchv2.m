function handles_out=drgCaImAn_pval_batchv2(handles_choices)
...
files_to_show=[2 2 2 6 6 6];
ROIs_to_show=[8 12 56 20 44 28];
            ...
            if sig_p==1
                ...
                if show_figures==1
                    ...
                    for trNo=1:size(dFFsminus,2)
                        plot(time_span',dFFsminus(:,trNo),'Color',[208/255 81/255 129/255],'LineWidth',0.5);
                    end

                    for trNo=1:size(dFFsplus,2)
                        plot(time_span',dFFsplus(:,trNo)','Color',[0 164/255 228/255],'LineWidth',0.5);
                    end
