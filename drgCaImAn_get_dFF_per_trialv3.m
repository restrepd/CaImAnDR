...
while (at_end==0)
    ...
    delta_ii_sp=find(epochs(this_ii+next_ii:end)~=epochs(this_ii+next_ii),1,'first');
    if ~isempty(next_ii)
        %This is S+
        ...
        if (no_points_after+this_ii+next_ii<length(epochs))&(this_ii+next_ii-no_points_before>0)
            ...
            this_ii=this_ii+next_ii+delta_ii_sp;
            sp_or_sm(trNo)=1;
        else
            if (no_points_after+this_ii+next_ii>length(epochs))
                at_end=1;
            end
            this_ii=this_ii+next_ii+delta_ii_sp;
        end
...
while (at_end==0)
    ...
    if ~isempty(next_ii)
        ...
        if (no_points_after+this_ii+next_ii<length(epochs))&(this_ii+next_ii-no_points_before>0)
            ...
            this_ii=this_ii+next_ii+delta_ii_sm;
            sp_or_sm(trNo)=0;
        else
            if (no_points_after+this_ii+next_ii>length(epochs))
                at_end=1;
