...
%Load the reference
[ref_outFileName,thisoutPathName] = uigetfile({'*.mat'},'Select the reference EXTRACT output file');

%Load the working
[working_outFileName,thisoutPathName] = uigetfile({'*.mat'},'Select the working EXTRACT output file');
