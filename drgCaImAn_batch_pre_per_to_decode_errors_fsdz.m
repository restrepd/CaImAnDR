function drgCaImAn_batch_pre_per_to_decode_errors_fsdz(choiceBatchPathName,choiceFileName)
...
if all_files_present==1
    ...
    for fileNo=first_file:length(handles.FileName_pre_per)
        ...
        for ii_thr=1:length(handles.p_threshold)
            ...
            handles_out.ii_out(ii_out).handles_out=drgCaImAn_SVZ_entire_session_errors(handles_choices);
